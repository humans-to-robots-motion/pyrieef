...
# sys.path.insert(0, os.path.abspath('../pyrieef'))
# sys.path.insert(0, os.path.abspath('..'))
sys.path.append('/Users/jmainpri/Dropbox/Work/workspace/pyrieef/')
sys.path.append('/Users/jmainpri/Dropbox/Work/workspace/pyrieef/pyrieef')
